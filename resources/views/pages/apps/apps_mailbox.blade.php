                                        ...
                                        <div class="mail-content-container mailInbox" data-mailfrom="info@mail.com" data-mailto="kingAndy@mail.com" data-mailcc="">
                                            ...
                                            <div class="d-flex justify-content-between mb-5">
                                                <div class="d-flex user-info">
                                                    ...
                                                    <div class="f-body">
                                                        <div class="meta-title-tag">
                                                            <h4 class="mail-usr-name" data-mailtitle="Hosting Payment Reminder">APOTEK ARAFAH ANWAR</h4>
                                                            <h5 class="mail-usr-name">Jl. Sawo No.2,Kec. Sukodono-Sidoarjo</h5>
                                                            <h5 class="mail-usr-name">(031) 8830989</h5>
                                                        </div>
                                                        <div class="meta-mail-time">
                                            ...
                                            <div class="invoice-00001">
                                                <div class="content-section  animated animatedFadeInUp fadeInUp">
                                                    ...
                                                    <div class="row inv--detail-section">
                                                        ...
                                                        <div class="col-sm-12 align-self-center mt-3 mb-3">
                                                            <p class="inv-to"><span class="inv-number text-primary underline">Resi Pembayaran Resep Obat</span></p>
                                                            <p>--------------------------------------</p>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-7 align-self-center">
                                                            <p class="inv-customer-name">TANGGAL PEMBAYARAN: <span class="inv-number text-primary"> 09/09/2020</span></p>
                                                        </div>

                                                        <div class="col-sm-7 align-self-center mt-5">
                                                            <p class="inv-customer-name"><span class="inv-number text-primary">Daftar Obat: </span></p>
                                                            <p>--------------------------------------</p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-7 align-self-center">
                                                            <p class="inv-customer-name">Subtotal: <span class="inv-number text-primary">65000</span></p>
                                                        </div>

                                                        <div class="col-sm-7 align-self-center mt-5">
                                                            <p class="inv-customer-name">Apoteker: </p>
                                                            <p>--------------------------------------</p>
                                                        </div>

                                                        <div class="col-sm-7 align-self-center">
                                                            <p class="inv-customer-name"><span class="inv-number text-primary">mr. Apoteker</span></p>
                                                        </div>
                                                    </div>
